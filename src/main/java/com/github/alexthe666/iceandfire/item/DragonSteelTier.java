...
public class DragonSteelTier {
    ...
    public static final TagKey<Block> DRAGONSTEEL_TIER_TAG = TagKey.create(Registries.BLOCK, new ResourceLocation("iceandfire:needs_dragonsteel"));
    ...
    private static Tier createTierWithRepairItem(Supplier<Ingredient> ingredient, String name) {
        return TierSortingRegistry.registerTier(
            new LazyTier(4, 8000, 10, 21, 10, DRAGONSTEEL_TIER_TAG, ingredient),
